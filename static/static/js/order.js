            ...
            success: function (response) {
                ...
                var staticURL = '../static/media/'
                        for (var j = 0; j < order_sku.length; j++) {
                            ...
                            html += '<b><a href="#"><img style="width:80px" src=' + staticURL + order_sku[j].default_image_url + ' /></a></b>'
