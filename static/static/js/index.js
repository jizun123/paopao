...
$(function () {
    $('#header').load('header.html', () => {
        //实现动态的显示登录和注册
        token = window.localStorage.getItem('paopao_token')
        ...
        $(".care").hover(function () {
            $(this).attr('src', local_ref+"/dadashop/static/images/header/care1.png");
        }, function () {
            $(this).attr('src', local_ref+"/dadashop/static/images/header/care.png");
        });
        $(".order").hover(function () {
            $(this).attr('src', local_ref+"/dadashop/static/images/header/order1.png");
        }, function () {
            $(this).attr('src', local_ref+"/dadashop/static/images/header/order.png");
        });
        $(".shopcar").hover(function () {
            $(this).attr('src', local_ref+"/dadashop/static/images/header/shop_car1.png");
        }, function () {
            $(this).attr('src', local_ref+ "/dadashop/static/images/header/shop_car.png");
        });
        //搜索跳转
        $('#search').click((e)=>{
            var val = $('#input').val();
