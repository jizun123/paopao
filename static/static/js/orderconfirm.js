function orders() {
                        ...
                        orderConfirm.data = {
                            html_goods: function () {
                                ...
                                for (var i = 0; i < data_goods.length; i++) {
                                    ...
                                    HTML += '</div>'
                                    HTML += '<b><img src="'+IMG_URL + data_goods[i].default_image_url + '" style="width:100px"/></b>'
                                    HTML += '</li>'
            ...
            if(sku_data==''){
                paramenter_url = "?status=0&settlement_type=0"
                settlement_type=0
                push_ajax(paramenter_url,settlement_type)
            }else{
                paramenter_url = sku_data+"&status=0&settlement_type=1"
                settlement_type=1
                push_ajax(paramenter_url,settlement_type)
            }
        }
